export default function Hero() {
  return (
    <section id="docs-start">
      <h2 className='scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight transition-colors first:mt-0'># Get Started</h2>
      <h1 className='scroll-m-20 mt-4 text-4xl font-extrabold tracking-tight lg:text-5xl'>X-Desire Team&apos;s Geological Data Platform</h1>
